/*Conatains code for the TABLES required for working of assembler*/
#include<iostream>
#include<map>
#include<string>
...
typedef map<string,literalStruct> LIT_TABLE_TYPE;
typedef map<string,labelStruct> SYMBOL_TABLE_TYPE;
typedef map<string,blocksStruct> BLOCK_TABLE_TYPE;
typedef map<string,registerStruct> REG_TABLE_TYPE;
